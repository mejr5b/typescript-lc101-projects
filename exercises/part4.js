...
console.log(" It would take " + spaceShuttle.getDaysToLocation(kilometersToMars) + " days for " + spaceShuttle.name + " to get to Mars.");
console.log("It would take " + spaceShuttle.getDaysToLocation(kilometersToTheMoon) + " days for " + spaceShuttle.name + " to get to the Moon.");
